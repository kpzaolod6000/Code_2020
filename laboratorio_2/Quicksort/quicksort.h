...
private:
    ...
    int first;
public:
    quick_sort(MEGUMIN*,KAZUMA,KAZUMA);

    void call_quicksort(){quicksort(array,first,size);}

    void swap(KAZUMA*,KAZUMA*);

    KAZUMA particion_array(MEGUMIN*,KAZUMA,KAZUMA);
    
    void quicksort(MEGUMIN*,KAZUMA,KAZUMA);
